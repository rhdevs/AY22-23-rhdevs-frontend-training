...
const SL_LiYuan = React.lazy(() => import(/* webpackChunckName: "LiYuan" */ './pages/YourShoppingListsHere/LiYuan'))
const SL_LiYuan_redux = React.lazy(
  () => import(/* webpackChunckName: "LiYuan_redux" */ './pages/YourShoppingListsHere/LiYuan_redux'),
)
// Add your Page here!
...
function App() {
  ...
  const routes = (
    <Switch>
      ...
      <Route path={`${PATHS.MISSIONS}/1/LiYuan`} exact component={SL_LiYuan} />
      <Route path={`${PATHS.MISSIONS}/1/LiYuan_redux`} exact component={SL_LiYuan_redux} />
      {/* Add your Route here! */}
